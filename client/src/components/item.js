...
class Item extends React.Component {
	...
	render() {
		if (this.props.button && this.props.version) {
			return <button onClick={this.props.onClick}><img src={imageURL(this.props.version, this.props.item.key)} alt={this.props.item.name} /><p style={pStyle}>{this.props.item.name}</p></button>;
